...
exports.author_create_post = function(req, res, next){
	...
	req.checkBody('date_of_birth', 'Invalid date').optional({ checkFalsy: true }) // .isDate({format: 'DD-MM-YYYY'});
	req.checkBody('date_of_death', 'Invalid date').optional({ checkFalsy: true }) // .isDate({format: 'DD-MM-YYYY'});
